...
Installing `hydromt_wflow` from the `conda-forge/label/` channel can be achieved by adding `conda-forge/label/` to your channels with:

```
conda config --add channels conda-forge/label/
conda config --set channel_priority strict
```

Once the `conda-forge/label/` channel has been enabled, `hydromt_wflow` can be installed with `conda`:
...
```
conda search hydromt_wflow --channel conda-forge/label/
```

or with `mamba`:

```
mamba search hydromt_wflow --channel conda-forge/label/
```
...
mamba repoquery search hydromt_wflow --channel conda-forge/label/

# List packages depending on `hydromt_wflow`:
mamba repoquery whoneeds hydromt_wflow --channel conda-forge/label/

# List dependencies of `hydromt_wflow`:
mamba repoquery depends hydromt_wflow --channel conda-forge/label/
```
...
* [@Tjalling-dejong](https://github.com/Tjalling-dejong/)
